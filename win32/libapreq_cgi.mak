...
!MESSAGE 
!MESSAGE "libapreq_cgi - Win32 Release" (based on "Win32 (x86) Static Library")
!MESSAGE "libapreq_cgi - Win32 Debug" (based on "Win32 (x86) Static Library")
!MESSAGE 
...
ALL : "$(OUTDIR)\libapreq_cgi.lib"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP_PROJ=/nologo /MD /W3 /O2 /D "WIN32" /D "NDEBUG" /D "LIBAPREQ_CGI_EXPORTS" /D "_WINDOWS" /I"$(APREQ_HOME)\src" /I"$(APACHE)\include" /Fp"$(INTDIR)\libapreq_cgi.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\libapreq_cgi.bsc" 
LIB32=link.exe -lib
LIB32_FLAGS=/nologo /nodefaultlib /out:"$(OUTDIR)\libapreq_cgi.lib" 
LIB32_OBJS= \
        "$(INTDIR)\libapreq_cgi.obj" \
        "$(INTDIR)\libapreq.lib" \
        "$(APACHE)\lib\libapr.lib"

"$(OUTDIR)\libapreq_cgi.lib" : "$(OUTDIR)" $(DEF_FILE) $(LIB32_OBJS)
    $(LIB32) @<<
...
CPP_PROJ=/nologo /MDd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_MBCS" /D "LIBAPREQ_CGI_EXPORTS" /D "_LIB" /I"$(APREQ_HOME)\src" /I"$(APACHE)\include" /Fp"$(INTDIR)\libapreq_cgi.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\libapreq_cgi.bsc" 
LIB32=link.exe -lib
LIB32_FLAGS=/nologo /out:"$(OUTDIR)\libapreq_cgi.lib" 
LIB32_OBJS= \
        "$(INTDIR)\libapreq_cgi.obj" \
        "$(INTDIR)\libapreq.lib" \
        "$(APACHE)\lib\libapr.lib"
